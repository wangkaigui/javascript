...
<?php } ?>
  ...
  <form action="<?php echo U('WxManage/addkeyword');?>" method="post" >
			...
			<tr style="width:80px;display:none;" id="imgId">
				...
				<td class="y-bg">
					<select name='cid' style="width:150px;">
						<?php if(is_array($data)): $key = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?><option value='<?php echo ($vo["id"]); ?>'><?php echo ($vo["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
					</select>
				</td>
			</tr>
