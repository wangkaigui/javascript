...
?>
        ...
        <tr>
          ...
          <span class="switch_list cc">
			...
			<label><input type="radio" name="info[status]" value="1"  <if condition=" $data['status']==1 "> checked</if>><span>待审核</span></label><br/>
			<label><input type="checkbox" name="info[isweixin]" value="1" <if condition=" $data['isweixin']==1 "> checked</if>><span>是否为微信文章</span></label>
		 </span></td>
        </tr>
      </table>
    </div>
