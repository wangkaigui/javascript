...
<?php } ?>
  ...
  <form action="<?php echo U("setConfig");?>" method="post" class="J_ajaxForm" >
<table width="100%">
	<tbody>
		<tr>
			<td width="140">APPkey</td>
			<td><input type="text" style="width:220px;height:22px;" name="appid" value="<?php echo ($info["appid"]); ?>" /></td>
		</tr>

		<tr>
			<td>APPsecret</td>
			<td><input type="text" style="width:220px;height:22px;" name="secret" value="<?php echo ($info["secret"]); ?>" /></td>
		</tr>
